        ...
        {menuItems.map((item) => (
          <Button
            ...
            className={`w-full justify-start ${
              activeTab === item.id ? "bg-emerald-500 hover:bg-emerald-600 text-white" : "hover:bg-muted"
            }`}
          ...
          >
            ...
            {item.badge && (
              <Badge variant="secondary" className="ml-auto bg-emerald-500/10 text-emerald-700 text-xs">
                {item.badge}
              </Badge>
            )}
          </Button>
