...
import { Eye, EyeOff, Mail, Lock, Building2, AlertCircle, ArrowRight, UserPlus } from "lucide-react";
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-2xl rounded-2xl p-8">
          <div className="mb-6">
            ...
            <p className="text-slate-300">Access your staff portal</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <div className="text-center">
              <p className="text-slate-400 mb-4">New employee?</p>
